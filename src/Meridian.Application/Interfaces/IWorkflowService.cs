...
public interface IWorkflowService<TData> where TData : class, IWorkflowData
{
    ...
    /// </summary>
    /// <param name="definitionId">The identifier of the workflow definition to be used for this request.</param>
    ...
    Task<WorkflowRequestInstance<TData>> CreateRequestAsync(string definitionId, TData inputData, string createdBy);
    ...
    Task<WorkflowRequestInstance<TData>> DoActionAsync(string requestId, string action, string performedBy, TData data, List<string> userRoles, List<string> userGroups);
    ...
    /// </returns>
    Task<WorkflowRequestInstance<TData>?> GetRequestAsync(string requestId);
    ...
    Task<List<WorkflowRequestInstance<TData>>> GetUserTasksAsync(string userId, List<string> userRoles, List<string> userGroups);
    ...
    List<WorkflowAction<TData>> GetAvailableActions(WorkflowRequestInstance<TData> request, string? userId = null, List<string>? userRoles = null, List<string>? userGroups = null);
    ...
    Task<List<WorkflowTransition>> GetRequestHistoryAsync(string requestId);
    ...
    Task<WorkflowWithHistoryDto<TData>> GetRequestWithHistoryAsync(string requestId);
}